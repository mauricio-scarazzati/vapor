    ...
    <form action="atualizar-categoria.php" method="post">
        <div class="row">
            <div class="input-container quarter">
                ...
                <input onclick="removerElementoPorID('mensagem-erro')" value="<?=$categoria['nome']?>" name="category" id="category" class="row-input" type="text" onkeyup="transformar_texto_em_maiusculo(this)">
